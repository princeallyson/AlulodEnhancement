...
{$can_activate 				= 'activate-navbar'|is_user_permission}

{$card_title 				= ('Update'|iif:$can_entry:'View')|iif:$id:'New'|concat:' Navbar'}

{$button_text 				= 'Update'|iif:$id:'Save'}
{$button_swal_positive_text = 'swal-positive-text="Yes, '|concat:('update'|iif:$id:'save')|concat:' it!"'}
{$button_swal_title 		= 'swal-title="Update Navbar?"'|iif:$id}
{$button_swal_text 			= ''|iif:$id:'swal-text="Save Navbar?"'}

{$delete_button_swal_title 	= 'swal-title="Delete Navbar?"'}
